...
var Default = map[any]interfaces.Handler{
	...
	&buttons.BackToAddPlantGroupButton:            BackToAddPlantGroupCallback,
	&buttons.AcceptAddPlantPhotoButton:            AcceptAddPlantPhotoCallback,
	&buttons.RejectAddPlantPhotoButton:            Delete,
	&buttons.BackToAddPlantPhotoQuestionButton:    BackToAddPlantPhotoQuestionCallback,
